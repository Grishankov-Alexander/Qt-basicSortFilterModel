...
Window::Window()
{
    ...
    filterPatternLabel = new QLabel(tr("&Filter patteern:"));
...
{
    auto syntax = QRegExp::PatternSyntax(
                filterSyntaxComboBox->currentData().toInt());
    auto caseSensitivity = filterCaseSensitivityCheckBox->isChecked()
